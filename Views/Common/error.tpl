    ...
    <style type="text/css">
    	*{
		...
		.error_cont{
			...
			background:url(__STATIC__/image/warning.gif) 32px 32px no-repeat;
			line-height:1.8;
		}
		.error_return{
			padding:10px 0 0 0;
		...
		.btn {
			color: #333;
			background:#e6e6e6 url(__STATIC__/image/btn.png);
    ...
    <div class="wrap">
	  <div id="error_tips">
	    ...
	    <div class="error_cont">
	      ...
	      <div class="error_return"><a href="javascript:;" onClick="javascript :history.back(-1);" class="btn">返回</a></div>
	    </div>
	  </div>
	</div>
